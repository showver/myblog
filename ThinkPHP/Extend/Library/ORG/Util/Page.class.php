...
class Page {
    ...
    public function show() {
        ...
        if($nowCoolPage == 1){
            ...
            $prePage    =   "<li><a href='".str_replace('__PAGE__',$preRow,$url)."' ><span aria-hidden='true'>&laquo;</span></a></li>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage   =   "<li><a href='".str_replace('__PAGE__',$nextRow,$url)."' ><span aria-hidden='true'>&raquo;</span></a></li>";
