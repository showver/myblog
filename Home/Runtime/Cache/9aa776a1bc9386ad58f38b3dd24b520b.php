			...
			<article class="mana_comment_a col-xs-10">
				...
				<div class="row">
					<form class="form-inline" action="__URL__/blogpinglunkey" method="get">
						...
						<div class="form-group col-xs-3" >
							...
							<select name="pingluntime" id="pingluntime" class="form-control">
				...
				<div class="row">
					<table class="table table-hover table-bordered table-responsive">
					  ...
					  <tbody id="tb_p_cbAll">
					  <?php if($reping == null): ?><tr>
						      <td colspan="7" class="text-center text-muted">
							    <p>暂无数据。。。。。。</p>
						      </td>
					        </tr>
					    <?php else: ?>
					    <?php if(is_array($reping)): foreach($reping as $key=>$p): ?><tr>
								...
								<td class="text-center"><?php echo (date("Y-m-d",$p['p_pubtime'] )); ?></td>
