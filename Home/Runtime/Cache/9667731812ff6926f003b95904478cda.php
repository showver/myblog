...
<!-- content Section -->
	<div class="container">
		...
		<?php if($blog == null): ?><div class="row">
		...
		<?php else: ?>
		    <?php if(is_array($blog)): foreach($blog as $key=>$b): ?><div class="row">
					<div class="col-sm-11" style="margin-bottom:: 20px;">
		 				<h3 class="text-primary" style="display: inline;"><a href="__URL__/detail?bid=<?php echo ($b['b_id']); ?>"><strong><?php echo ($b['b_title']); ?></strong></a></h3>
