			...
			<article class="mana_comment_a col-xs-10">
				...
				<div class="row">
					<table class="table table-hover table-bordered table-responsive">
					   ...
					   <tbody id="tb_p_cbAll">
					   <?php if($reshen == null): ?><tr>
						      <td colspan="7" class="text-center text-muted">
							    <p>暂无数据。。。。。。</p>
						      </td>
					        </tr>
					    <?php else: ?>
						<?php if(is_array($reshen)): foreach($reshen as $key=>$s): ?><tr>
								...
								<td class="text-center"><?php echo (date("Y-m-d",$s['p_pubtime'] )); ?></td>
				...
				<?php if($page == '   '): if($reshen == null): else: ?>
